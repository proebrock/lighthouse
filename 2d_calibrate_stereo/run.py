...
from common.aruco_utils import charuco_calibrate, charuco_find_corners
...
def aruco_calibrate_stereo(filenames_l, filenames_r, \
    ...
    images_l, images_used_l, all_corners_l, all_ids_l, image_size_l = \
        charuco_find_corners(filenames_l, aruco_dict, aruco_board)
    images_r, images_used_r, all_corners_r, all_ids_r, image_size_r = \
        charuco_find_corners(filenames_r, aruco_dict, aruco_board)
...
if __name__ == "__main__":
    ...
    for cam_no in range(num_cams):
        _, _, board_pose, cam_pose, cam_matrix, cam_distortion = \
            load_params(data_dir, cam_no, 0)
